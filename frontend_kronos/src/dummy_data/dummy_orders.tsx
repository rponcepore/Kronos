...
const dummyData: KronosResponse = {
  ...
  paragraphs_vec: [
    ...
    { id: 10, order: 2, parent_paragraph: null, is_major: true, ordinal_sequence: 5, title: "Command and Signal", text: "S3 operations will distribute further instructions via OPORD 25-00-01.", indent_level: 0 },
